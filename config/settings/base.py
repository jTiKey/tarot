...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///tarot'),
}
...
LOCAL_APPS = [
    'tarot.users.apps.UsersAppConfig',
...
MIGRATION_MODULES = {
    'sites': 'tarot.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'tarot.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'tarot.users.adapters.SocialAccountAdapter'
